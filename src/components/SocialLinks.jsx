...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/raditzoffc/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@raditzoffc",
    icon: Instagram,
    url: "https://www.instagram.com/raditz_offc1",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@raditzoffc",
    icon: Youtube,
    url: "https://www.youtube.com/@raditzoffc",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@raditzoffc",
    icon: Github,
    url: "https://github.com/RADITZ-OFFC",
    color: "#ffffff",
